...
export class MyTicketsComponent implements OnInit {
  ...
  ngOnInit(): void {
    // In real app, fetch user's tickets from API
    this.tickets.set([
      {
        id: '1', ticketNumber: 'BT-20250606-0001', tripId: '1', passengerName: 'John Doe', passengerMobile: '01700000001',
        seatNumbers: ['A1', 'A2'], totalFare: 2400, status: 'Confirmed', bookedAt: new Date().toISOString(),
        busName: 'Green Line', routeName: 'Dhaka → Chittagong', departureTime: '08:00', arrivalTime: '14:00', travelDate: new Date().toISOString().split('T')[0]
      }
    ]);
  }
  ...
  cancelTicket(ticketId: string): void {
    ...
    // TODO: Call api.post(`/booking/tickets/${ticketId}/cancel`, { reason: 'Cancelled by user' })
    alert('Ticket cancelled successfully. Refund will be processed.');
  }
}