    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketNumberCounters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    BoothName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    RoleId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    ModifiedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistanceKm = table.Column<decimal>(type: "numeric(9,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowLabel = table.Column<string>(type: "character varying(2)", maxLength: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FareAmount = table.Column<decimal>(type: "numeric(9,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NidOrPassport = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Gender = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    Remarks = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    FareAmount = table.Column<decimal>(type: "numeric(9,2)", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    SoldByUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    SoldAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_OriginStationId_DestinationStationId",
                table: "Routes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketNumberCounters_CounterDate",
                table: "TicketNumberCounters",
                column: "CounterDate",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_MobileNumber",
                table: "Tickets",
                column: "MobileNumber");

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ScheduleId_TravelDate_SeatId",
                table: "Tickets",
                columns: new[] { "ScheduleId", "TravelDate", "SeatId" },
                unique: true,
                filter: "\"Status\" = 0");
